...
public class CruddemoApplication {
	...
	public CommandLineRunner commandLineRunner(AppDAO appDAO){
		...
		return runner -> {
			...
			//createInstructor(appDAO);  //One-to-One

			//findInstructor(appDAO);	//One-to-One

			//deleteInstructor(appDAO);	//One-to-One
			...
			//findInstructorDetail(appDAO);	//One-to-One

			//deleteInstructorDetail(appDAO);	//One-to-One
	...
	private void createInstructorWithCourses(AppDAO appDAO) {
		...
		//
		// MOTE: this will ALSO save the courses
		//
